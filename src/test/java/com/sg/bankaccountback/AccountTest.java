...
public class AccountTest {
    ...
    public void testWithdrawal(){
        float initialBalance = account.getBalance();
        float amount = 10;
        accountService.withdraw(1, 10, Operation.WITHDRAWAL);
    ...
    public void testWithdrawHighAmount(){
        try {
            accountService.withdraw(1,1000, Operation.WITHDRAWAL);
        } catch (BadRequestException e) {
        }
    }
    ...
    public void testWithdrawalBlockedAcc(){
        try {
            accountService.withdraw(2, 10, Operation.WITHDRAWAL);
    ...
    public void testWithdrawalClosedAcc(){
        try {
            accountService.withdraw(3,10, Operation.WITHDRAWAL);
        } catch (NotAllowedException e) {
        }
    }
    ...
    public void testGetHistory(){
        try {
            assertNull(accountService.history(1));
        } catch (NotFoundException e) {
        }
    }
